...
| D4–D6 Expiry/FEFO/warnings | Inventory details; Overview expiry count | Date rules and known warnings; canonical FEFO policy/projection evidence deferred |
...
| E5–E6 Sales batches/corrections | Daily Update → Sales intervals | Complete intervals, source/identity, zero/omission convention, event-backed correction history |
...
| G4–G6 Policy/domain | Recommendations → Policy | Policy name and constraints explained; no proposed constants passed as authoritative inputs |
...
| H4–H5 Agent investigation/explanation | Assessment detail and recommendation evidence | Stored outcomes/reasons exposed; unavailable tool narrative not fabricated |
...
Dedicated historical-offer browsing, canonical policy transport, full projection charts, persisted agent tool narratives, materiality certification, complete economic ledgers and validated emergency/contingency outputs require their final backend contracts. The manager UI preserves a visible place for these capabilities and uses the available audit/record views in the meantime.
